...
return [
    ...
    */
    ...
    'after_or_equal' => ':attribute не может быть меньше :date.',
    ...
    'before_or_equal' => ':attribute не может быть больше :date.',
    ...
    'distinct' => ':attribute содержит повторяющиеся значения.',
    ...
    'string' => 'Значение может быть только строкой.',
