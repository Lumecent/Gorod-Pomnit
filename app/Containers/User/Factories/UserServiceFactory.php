...
use App\Containers\User\Services\LoadAvatarUserService;
...
class UserServiceFactory
{
    ...
    public static function getLoadAvatarUserService(): LoadAvatarUserService
    {
        return app( LoadAvatarUserService::class );
    }
}